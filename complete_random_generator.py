...
non_mid_consonant_list = [letter for letter in lower_alphabet if letter not in mid_consonant_list]
...
if starter_letter in vowel_list:
    ...
    word_component_list.append(random.choice([random.choice(mid_consonant_list), random.choice(vowel_list)]))
